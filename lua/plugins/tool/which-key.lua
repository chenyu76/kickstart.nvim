return { -- Useful plugin to show you pending keybinds.
  ...
  opts = {
    ...
    spec = {
      ...
      { '<leader>r', '<cmd>lua Compile_current_file()<CR>', desc = '[R]un file', mode = 'n', icon = '' },
      { '<leader>R', '<cmd>lua Compile_current_file_with_arg()<CR>', desc = '[R]un file with args', mode = 'n', icon = '' },
      { '<leader>tc', '<cmd>lua require("copilot.suggestion").toggle_auto_trigger()<CR>', desc = '[T]oggle [C]opilt', mode = 'n', icon = '' },
      { '<leader>tp', '<cmd>lua ViewCorrespondingPDF()<CR>', desc = 'View PDF', mode = 'n', icon = '' },
